...
cleaned as (
    ...
    select
        ...
        trim(upper(coalesce(parent_appointment_id, null)))                   as parent_appointment_id,
        ...
        case
            when actual_start_time is not null and actual_end_time is not null
                then datediff('minute',
                              try_cast(actual_start_time as timestamp_ntz),
                              try_cast(actual_end_time   as timestamp_ntz))
