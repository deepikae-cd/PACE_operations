...
cleaned as (
    ...
    select
        ...
        try_cast(visit_date as timestamp_ntz)                              as visit_date,
        coalesce(try_cast(visit_duration_minutes as number(5,0)), 0)       as visit_duration_minutes,
        ...
        coalesce(try_cast(vitals_heart_rate   as number(5,0)),  null)      as vitals_heart_rate,
        coalesce(try_cast(vitals_temperature  as number(5,2)),  null)      as vitals_temperature_f,
        coalesce(try_cast(vitals_weight_lbs   as number(6,2)),  null)      as vitals_weight_lbs,
        coalesce(try_cast(vitals_o2_saturation as number(5,2)), null)      as vitals_o2_saturation,
